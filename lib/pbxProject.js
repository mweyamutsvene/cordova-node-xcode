...
pbxProject.prototype.addTarget = function(name, type, subfolder) {
    ...
    } else if (targetType === 'ui_test_bundle'){
        var uitarget = this.getTarget(producttypeForTargettype('ui_test_bundle'));
        this.addTargetDependency(uitarget.uuid,[this.getFirstTarget().uuid]);
    }
    else {
